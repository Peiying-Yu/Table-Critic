...
*/
The Bombers scored 29 points in the first game and 29 points in the second game against the BC Lions. By adding these scores together, the total points scored by the Bombers against the BC Lions is 58. So the statement is true.
...
row 1 : 2003     | 44.67               
*/
The election in row 1, which is the 2003 election, was the first to reach over 40% of the popular vote with 44.67%. So the statement is false.
...
Statement:
1965 was the first year of rugby of the terrapins
...
*/
The first year of rugby for the Terrapins was 1963. So the statement is false.
...
Statement: 
8 times, total, was the result "won"
...
Group 2 | nominated | 2
*/
The result "won" appears 8 times in the table. So the statement is true.
...
Statement:
chalupny scored in 2 consecutive friendly competitions
...
Group 1 | friendly | 3
*/
Chalupny did not score in any consecutive friendly competitions. The gaps in dates between her goals indicate non-consecutive friendly matches. So the statement is false.
...
Statement:
there are 4 division 1 teams that were founded before 1950
...
*/
The clubs founded before 1950 that are in Division 1 are Eltham Football Club, Greensborough Football Club, and Heidelberg Football Club. So the statement is true.
...
row 8 :  0
*/
The average score of all home team members for all dates can be calculated by adding all the scores together and dividing by the number of rows. The sum of all scores is 17 (4+2+1+1+2+3+1+0) and there are 8 rows. Therefore, the average score is 2.125. So the statement is true.
...
if __name__=="__main__":
    ...
    file_path = "critic/TableFV/tools/few_shot_tree.json"
